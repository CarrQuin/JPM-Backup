...
$register_url = $setting->get_value('registration-page-url');
    ...
    <form id="swpm-login-form" name="swpm-login-form" method="post" action="">
        ...
        <div class="swpm-login-form-inner">
            ...
            <div class="swpm-join-us-link">
                <a id="register" class="swpm-login-form-register-link" href="<?php echo esc_url($register_url); ?>"><?php _e('Join Us', 'simple-membership') ?></a>
            </div>
            <?php } ?>
