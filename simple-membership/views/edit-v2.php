...
<div class="swpm-edit-profile-form">
    <form id="<?php echo $form_id ?>" class="swpm-form" name="swpm-editprofile-form" method="post" action="">
        ...
        <div>
			...
			<div class="swpm-form-row swpm-logged-expiry-row" <?php apply_filters('swpm_edit_profile_form_logged_expiry_tr_attributes', ''); ?>>
                <div class="swpm-form-label-wrap swpm-form-username-label-wrap">
                    <label for="expiry_date"><?php _e('Account Expiry', 'simple-membership') ?></label>
                </div>
                <div class="swpm-form-input-wrap swpm-form-logged-expiry-input-wrap"><?php echo $auth->get_expire_date(); ?></div>
            </div>
